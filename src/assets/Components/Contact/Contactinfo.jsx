                                        ...
                                        datas.map(data => (
                                            <tbody key={data._id} className="bg-white divide-y divide-gray-200 ">
                                                <tr>
                                                        ...
                                                        <div className="inline-flex items-center gap-x-3">
                                                            ...
                                                            <div className="flex items-center gap-x-2">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-sm font-normal dark:text-gray-400">{data.email}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">{data.number}</td>
                                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">{data.email}</td>
                                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                        <button className="btn text-3xl bg-red-600 text-white"><FaDeleteLeft></FaDeleteLeft></button>
                                                        <Link className="btn text-3xl ml-2 bg-yellow-500 text-white"><TfiFiles></TfiFiles></Link>
                                                    </td>
                                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
            ...
            <div className="py-16">
                <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                    <div className="hidden lg:block lg:w-1/2 h-full">
                        <img className="h-full" src="https://images.unsplash.com/photo-1546514714-df0ccc50d7bf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=667&q=80" alt="" />
                    </div>
