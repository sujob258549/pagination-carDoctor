...
const Contact = () => {
    ...
    return (
        ...
        <div>
            <Navber></Navber>
            <section className="min-h-screen bg-gradient-to-r from-blue-600 via-blue-800 ">
                            ...
                            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl lg:max-w-xl">
                                ...
                                <form onSubmit={handelcontactFrom} className="mt-4">
                                    ...
                                    <div className="flex-1 mt-6">
                                        ...
                                        <input name="number" type="number" placeholder="Your Phone number" className="block w-full px-5 py-3 mt-2  bg-white border border-gray-200 rounded-md  dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" />
                                    </div>

                                    <div className="w-full mt-6">
                                        <label className="block mb-2 text-sm ">Message</label>
                                        <textarea name="textarea" className="block w-full h-32 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-48  dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" placeholder="Message"></textarea>
                                    </div>
